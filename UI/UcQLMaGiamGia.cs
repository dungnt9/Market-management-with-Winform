...
namespace market_management.UI
{
    public partial class UcQLMaGiamGia : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            FrmTaoMGG frmMGG = new FrmTaoMGG();
            frmMGG.ShowDialog();
        ...
        {
            string s1 = string.Format("UPDATE MA_GIAM_GIA SET TrangThai = 0, MoTa = N'Lỗi' WHERE DATEDIFF(DAY, NgayTao, NgayHetHan) < 0 AND NOT(NgayHetHan = '1900-01-01')");
